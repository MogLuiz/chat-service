...
import (
	...
	"github.com/MogLuiz/gpt-consumer/chatservice/internal/infra/db"
)
...
func NewChatRepositoryMySQL(databaseConection *sql.DB) *ChatRepositoryMySQL {
	return &ChatRepositoryMySQL{
		DB:      databaseConection,
		Queries: db.New(databaseConection),
	}
}
